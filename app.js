...
window.onload = function () {
  ...
  const cardContainer = document.querySelector(".card-burger_container");
  ...
  function displayTimer() {
    const countDate = new Date("December 22, 2023 00:00:00").getTime();
  ...
  function headerBtnsCustomStyle() {
    const headerBtnsButton = document.querySelectorAll(
  ...
  function displayCardData() {
    ...
    card.classList.add("card-burger_view", "card-cube_view");
    card.innerHTML = `
      <div class="card-burger-img_container flex_center">
        <img src="${cardPhotoSrc}" alt="card photo" width="100%" />
      </div>
      <div class="card-burger_description">
        <h2 class="card-burger_title ff-sans_pro">${cardTitle}</h2>
        <div class="card-burger_check card-burger-border_top">
          <span class="check_img">
            <img src="./assets/cardCheck.png" alt="check" />
          </span>
          <p class="card-burger_para width_full ff-pt_sans">${cardParaOne}</p>
        </div>
        <div class="card-burger_check card-burger-border_top card-burger-border_bottom">
          <span class="check_img"><img src="./assets/cardCheck.png" alt="check" /></span>
          <p class="card-burger_para width_full ff-pt_sans">${cardParaTwo}</p>
        </div>
        <div class="card-burger-btn_container">
          <button class="btn-secondary card-burger_btn" type="button">${cardBtnText}</button>
        </div>
      </div>
    `;
    cardContainer.appendChild(card);
  });
    const removeCard = document.querySelectorAll(".card-burger_view");
    const removeCardDesc = document.querySelectorAll(
      ".card-burger_description"
    );
  ...
  function viewBtnsHandler() {
    const burgerViewCard = document.querySelector(".card-burger_container");
    burgerViewCard.classList.remove(
      "card-cube-view_container",
      "card-cube_view",
      "card-img_container",
      "card_title",
      "card_para",
